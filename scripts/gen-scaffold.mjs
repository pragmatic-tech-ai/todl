// Generate src/solution-services/project-services/core/scaffold.generated.ts from the scaffold .md
...
// src/solution-services/project-services/core/scaffold/). Shared TODL docs first, then per-project-type
...
const read = (file) =>
  readFileSync(new URL(`../src/solution-services/project-services/core/scaffold/${file}`, import.meta.url), "utf8");

let out = "// GENERATED from src/solution-services/project-services/core/scaffold/*.md by scripts/gen-scaffold.mjs — do not edit by hand.\n";
for (const { name, file } of SOURCES) {
  out += `export const ${name} = ${JSON.stringify(read(file))};\n`;
}
writeFileSync(new URL("../src/solution-services/project-services/core/scaffold.generated.ts", import.meta.url), out);
console.log("wrote src/solution-services/project-services/core/scaffold.generated.ts");
