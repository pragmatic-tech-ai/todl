...
import { PackageCompiler, type CompileResult } from "./package-compiler.js";
...
/** Compile a project against its installed/registry dependencies and write its
 *  npm package layout to the output directory. */
