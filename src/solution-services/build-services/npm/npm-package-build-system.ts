...
// The npm-package output (spec §4): resolve bases -> compile model -> emit the package
// layout. Applies to the publishable project types (meta-model + library); an
// architecture is not published as an npm package. Presentation baking is a mural-
// coupled project content generator added by the host (Plexus) when available; the
// headless pipeline produces the model + handle + resources.
