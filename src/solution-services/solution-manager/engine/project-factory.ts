...
export { type IProjectFactory } from '../../project-services/core/project-factory.js'
...
export type ProjectFactoryResolver = (typeId: string) => import('../../project-services/core/project-factory.js').IProjectFactory | undefined
