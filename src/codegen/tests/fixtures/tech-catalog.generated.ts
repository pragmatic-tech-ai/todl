...
import { ReflectedRepository, ReflectedEntity } from "../../../index.js";
import type { EntityReader, InstanceDescriptor, NodeId, Scalar, TodlDocument } from "../../../index.js";

export class TechCatalog extends ReflectedRepository {
  static fromJSON(doc: TodlDocument): TechCatalog {
    const client = new TechCatalog();
    client.load(doc, "tech-catalog", "0.0.0");
    return client;
  }
